...
#define ESP32C5_CPU_INT_COUNT       (ESP_CPU_INT_LINES)

#define ESP32C5_INT_MATRIX_OUTPUT_NAME "misc.esp32c5.intmatrix.out_irqs"

#define TYPE_ESP32C5_INTMATRIX "misc.esp32c5.intmatrix"
#define ESP32C5_INTMATRIX(obj) \
    OBJECT_CHECK(ESP32C5IntMatrixState, (obj), TYPE_ESP32C5_INTMATRIX)
...
typedef struct ESP32C5IntMatrixState {
    ...
    uint8_t irq_prio[ESP32C5_CPU_INT_COUNT + 1];
    uint8_t irq_thres;
...
} ESP32C5IntMatrixState;

_Static_assert(sizeof(uint64_t) * 2 * 8 >= ESP32C5_INT_MATRIX_INPUTS,
