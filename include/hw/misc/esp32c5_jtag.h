...
#define TYPE_ESP32C5_JTAG "misc.esp32c5.usb_serial_jtag"
#define ESP32C5_JTAG(obj) OBJECT_CHECK(ESP32C5UsbJtagState, (obj), TYPE_ESP32C5_JTAG)

#define ESP32C5_JTAG_REGS_SIZE (0x84)
...
typedef struct ESP32C5UsbJtagState {
